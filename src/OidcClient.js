...
export class OidcClient {
    ...
    createSigninRequest({
        ...
        resource, request, request_uri, response_mode, extraQueryParams, extraTokenParams, request_type, skipUserInfo, login_uri } = {},
        stateStore
    ) {
        ...
        // custom
        login_uri = login_uri || this._settings.login_uri;
